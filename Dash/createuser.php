                        ...
                        <div class="card border">
                            <div class="card-body"
                                ...
                                <h4 class="mt-0 pt-2 text-center"
                                    ...
                                    <span style="color:grey;">ADD USER</span></h4>
                                <div>
                                    <form action="createuseraction.php" method="POST" enctype="multipart/form-data">
                                        <!-- Image Uploader -->
                                        <div class="form-group" style="margin-bottom: 20px; text-align: center;">
                                            <div style="position: relative; display: inline-block;">
                                                <img id="avatarPreview" src="assets/images/avatar.png"
                                                    alt="Avatar Preview"
                                                    style="border-radius: 50%; width: 150px; height: 150px; object-fit: cover; border: 3px solid #f6571e;">
                                        ...
                                        <div class="form-group" style="margin-bottom: 20px;">
                                            <label for="exampleInputNumber"
                                                ...
                                                Number</label>
                                            <input type="number" name="numb" class="form-control"
                                                id="exampleInputNumber" placeholder="Number" required
                                                style="border-radius: 4px; padding: 12px; border: 2px solid #f6571e;">
                                        </div>
                                        <div class="form-group" style="margin-bottom: 20px;">
                                            <label for="exampleInputNumber"
                                            ...
                                            <input type="file" name="banner" class="form-control"
                                                id="exampleInputNumber" placeholder="Banner" required
                                                style="border-radius: 4px; padding: 12px; border: 2px solid #f6571e;">
                                        </div>

                                        <button type="submit" name="Submit" class="btn btn-primary mt-3"
                                            style="background-color: #f6571e; border-color: #f6571e; padding: 12px 24px; border-radius: 4px; color: #ffffff; font-weight: 600; font-size: 22px;letter-spacing:2px; width: 100%;">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
