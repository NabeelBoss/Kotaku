...
if (isset($_GET["updateid"])) {
    $update_id = intval($_GET["updateid"]);
    
    $query = "SELECT * FROM games WHERE gameid = $update_id";
                        ...
                        <div class="card border" style="border-radius: 8px; border: 1px solid #ddd;">
                            <div class="card-body"
                                ...
                                <h4 class="mt-0 pt-2 text-center"
                                    ...
                                    <span style="color:grey;">Update Game</span></h4>
                                <div>
                                    <form action="updategameaction.php" method="POST" enctype="multipart/form-data">
                                        <!-- Image Uploader -->
                                        <div class="form-group" style="margin-bottom: 20px; text-align: center;">
                                            <div style="position: relative; display: inline-block;">
                                                <img id="avatarPreview" src="../<?php echo $user["gameimage"] ?>"
                                                alt="Avatar Preview" style="border-radius: 50%; width: 150px; height:
                                                150px; object-fit: cover; border: 3px solid lightgrey;">
                                        ...
                                        <div class="form-group" style="margin-bottom: 20px;">
                                            <label for="exampleInputName"
                                                style="display: block; margin-bottom: 8px; font-weight: 500; color: grey;">Game
                                                Name</label>
                                            <input type="text" name="gamename" value="<?php echo $user["gamename"] ?>"
                                            class="form-control" id="exampleInputName" placeholder="Name" required
                                            style="border-radius: 4px; padding: 12px; border: 2px solid lightgrey;">
                                        </div>
                                        <div class="form-group" style="margin-bottom: 20px;">
                                            <label for="exampleInputEmail1"
                                                style="display: block; margin-bottom: 8px; font-weight: 500; color: grey;">Page
                                                URL</label>
                                            <input type="text" name="gameurl" value="<?php echo $user["gameurl"] ?>"
                                            class="form-control" id="exampleInputEmail1" placeholder="URL" required
                                            style="border-radius: 4px; padding: 12px; border: 2px solid lightgrey;">
                                        </div>
                                        <input type="hidden" name="updateid" value="<?php echo $update_id ?>">
